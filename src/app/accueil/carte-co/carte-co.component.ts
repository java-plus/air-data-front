...
@Component({
  selector: 'app-carte-co',
  templateUrl: './carte-co.component.html',
  styleUrls: ['./carte-co.component.scss']
})
export class CarteCoComponent implements OnInit {
